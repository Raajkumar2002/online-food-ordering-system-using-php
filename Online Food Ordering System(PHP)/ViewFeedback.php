	  ...
	  <div style="background-color:#009999; border-top-left-radius:35px; border-bottom-right-radius:35px; width:80%;">
	    <center>
	      <form id="form1" name="form1" method="post" action="">
	        <table width="500px" style=" color:#FFFFFF; font-size:14px">
	          <tr>
	            <td colspan="2">&nbsp;</td>
    </tr>
	          <tr>
                <td colspan="2" style="font-size:26px; font-weight:bold" align="center">View Feedback </td>
	            </tr>
	          <tr>
	            <td width="222">&nbsp;</td>
      <td width="258">&nbsp;</td>
...
//	$name=$_POST['name'];
	...
	$result =mysql_query("Select * from Feedback where Response='wait'");
	$id = $_POST['menu1'];
    ...
    <tr>
	  ...
	  <td> <a href="ResponseFeedback.php?id=<?php echo $row["UserName"] ?>"> <font color="red"><Strong>RESPONSE </a>	 
    </tr>
